...
|:---------|:--------------------|:--------------|:------------|
| 6.12.60  | zynqmp-fpga-generic | 1             | [6.12.60-zynqmp-fpga-generic-1](https://github.com/ikwzm/ZynqMP-FPGA-Linux-Kernel-6.12/tree/6.12.60-zynqmp-fpga-generic-1) |
...
```console
shell$ export RELEASE_TAG=6.12.60-zynqmp-fpga-generic-1
