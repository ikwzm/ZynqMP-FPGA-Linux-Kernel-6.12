Make ./paches/linux-6.12.60-xlnx-v2025.1/
------------------------------------------------------------------------------------

### Get linux-6.12.60

```console
shell$ git clone --depth 1 -b v6.12.60 git://git.kernel.org/pub/scm/linux/kernel/git/stable/linux-stable.git linux-6.12.60
```

### Get linux-xlnx-2025.1-update

```console
shell$ git clone --depth 1 -b xlnx_rebase_v6.12_LTS_2025.1_update https://github.com/Xilinx/linux-xlnx.git linux-xlnx-2025.1-update
```

### Make diff-linux-6.12.60-xlnx-v2025.1-update.txt

```console
shell$ ruby ./make-patches/source-tree-diff-list.rb -t linux-6.12.60-xlnx-v2025.1-update -A linux-6.12.60 -B linux-xlnx-2025.1-update -o ./make-patches/diff-linux-6.12.60-xlnx-v2025.1-update.txt linux-6.12.60 linux-xlnx-2025.1-update -v
## source-tree-diff-list.rb 0.1.1
## NAME: linux-6.12.60-xlnx-v2025.1-update
## A   : {name: linux-6.12.60, path: linux-6.12.60}
## B   : {name: linux-xlnx-2025.1-update, path: linux-xlnx-2025.1-update}
## OUT : ./make-patches/diff-linux-6.12.60-xlnx-v2025.1-update.txt
```

### Make make-patches-linux-6.12.60-xlnx-v2025.1-update.sh

```console
shell$ ruby ./make-patches/make-patch-shell.rb -d ./make-patches/diff-linux-6.12.60-xlnx-v2025.1-update.txt -g make-patches/patch-group-linux-6.12.60-xlnx-v2025.1.yml -s ./make-patches/make-patches-linux-6.12.60-xlnx-v2025.1-update.sh
```

### Run make-patches-linux-6.12.60-xlnx-v2025.1-update.sh

```console
shell$ sh ./make-patches/make-patches-linux-6.12.60-xlnx-v2025.1-update.sh
